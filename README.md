# Backend Guidelines &middot; [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
...
![Architecture](/images/folder-tree.png)

- We will be using a modular architecture in our projects. [learn more...](https://awesome-architecture.com/modular-monolith/)

  _Why:_

  > This approach allows for greater flexibility and scalability, making it easier to manage and evolve our projects over time. It also promotes reusability and separation of concerns, which can lead to more efficient and maintainable code.
  >
...
### 8.1 Some code style guidelines
...
- Logging is vital for monitoring and debugging applications. Ensure effective logging practices by incorporating the following :

  > `Timestamp`: Records the time of an event occurrence.
  >

  > `Log Level`: Specifies the severity level of the logged event.
  >

  > `Request ID`: Identifies individual requests for tracking and correlation.
  >

  > `Module`: Indicates the specific module or component generating the log.
  >

  > `Stack Trace`: Provides a trace of the call stack for error investigation.
  >
...
- Error Response, Most endpoints have many ways to fail. From unauthorized access to wrongful parameters etc. All of those should be listed here. It might seem repetitive, but it helps prevent assumptions from being made. For example
  ...
  ```
- Use API design tools, There are lots of open source tools for good documentation for us we will use [Swagger](https://swagger.io/).
